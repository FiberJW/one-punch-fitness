  ...
  module Container = {
    ...
    let make = (~onLayout=?, children) =>
      ReasonReact.wrapJsForReason(
        ...
        ~props={"onLayout": Js.Nullable.fromOption(onLayout)},
        children,
      );
  };
  module Title = {
  ...
  module Stats = {
    ...
    module Column = {
      ...
      let make = (~center=?, children) =>
        ReasonReact.wrapJsForReason(
          ~reactClass=column,
          ~props={"center": Js.Nullable.fromOption(center)},
          children,
        );
    };
    module BarContainer = {
  ...
  let make = (~workout: Progenitor.workout, ~parentContainerWidth, _children) => {
    ...
    render: self =>
      <Styled.Stats.Container parentContainerWidth>
        <Styled.Stats.Column>
          <Styled.Stats.Title>
            (ReasonReact.string("push-ups"))
          </Styled.Stats.Title>
          <Styled.Stats.Title>
            (ReasonReact.string("sit-ups"))
          </Styled.Stats.Title>
          <Styled.Stats.Title>
            (ReasonReact.string("squats"))
          </Styled.Stats.Title>
          <Styled.Stats.Title>
            (ReasonReact.string("running"))
          </Styled.Stats.Title>
        </Styled.Stats.Column>
        ...
        <Styled.Stats.Column>
          ...
          <Styled.Stats.Amount>
            (ReasonReact.string(workout.setsCompleted.run ? "10km" : "0 km"))
          </Styled.Stats.Amount>
        </Styled.Stats.Column>
